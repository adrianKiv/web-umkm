...
<div class="mb-3">
    ...
    <select class="form-select @error('id_role') is-invalid @enderror" id="id_role" name="id_role" required>
        <option value="1" {{ old('id_role', $user->id_role) == 1 ? 'selected' : '' }}>User</option>

        <option value="2" {{ old('id_role', $user->id_role) == 2 ? 'selected' : '' }}>Admin</option>

        @if(Auth::user()->isSuperAdmin())
            <option value="3" {{ old('id_role', $user->id_role) == 3 ? 'selected' : '' }}>Super Admin</option>
        @endif
    </select>
