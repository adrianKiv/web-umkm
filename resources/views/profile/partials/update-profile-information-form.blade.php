<section>
    ...
    <div class="d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#collapseProfileInfo" aria-expanded="{{ $errors->has('name') || $errors->has('email') ? 'true' : 'false' }}" style="cursor: pointer;">
        <header>
