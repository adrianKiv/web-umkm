...
html, body {
    ...
    margin: 0;
    padding: 0;
    min-height: 100vh; /* TAMBAHKAN BARIS INI */
}
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    ...
                    <p class="text-muted small">Pemberdayaan UMKM Kuliner melalui digitalisasi di kawasan Universitas Pendidikan Indonesia.</p>
