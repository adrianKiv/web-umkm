(function () {
    function bindModalZIndexById(id, backdropAttr) {
        ...
        modalEl.addEventListener('show.bs.modal', function () {
            ...
            requestAnimationFrame(() => {
                const backdrop = document.querySelector('.modal-backdrop.show:not([' + backdropAttr + '])');
                if (backdrop) {
                    backdrop.dataset[backdropAttr.replace(/[-@]/g, '')] = 'true';
        ...
        modalEl.addEventListener('shown.bs.modal', function () {
            modalEl.style.zIndex = '1115';
            const backdrop = document.querySelector('.modal-backdrop.show[' + backdropAttr + '="true"]');
        ...
        modalEl.addEventListener('hidden.bs.modal', function () {
            ...
            if (backdrop) {
                ...
                try { delete backdrop.dataset[backdropAttr.replace(/[-@]/g, '')]; } catch (e) {}
            }
        });
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        bindModalZIndexById('menuSubmissionModal', 'data-menu-submission-backdrop');
